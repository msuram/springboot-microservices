...
import com.aceinfo.exceptions.UserNotFoundException;
...
public class AuthenticationService implements IAuthenticationService {
	...
	public AuthenticationResponse ValidateByUserLogin(String userLogin, String password) {
		...
		if (user != null && user.getUserStatus() && user.getUserPassword().equals(password)) {
			...
			new UserNotFoundException("User Login Name not found") ;
			return null;
		}
	...
	public String DecryptPassword(String encriptedPassword) {
		/* TODO */
		return null;
	}
